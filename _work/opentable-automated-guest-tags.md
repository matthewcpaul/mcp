...
1. Different tag types could be applied to a guest—visit tags for the reservation card and guest tags for the guest profile; OpenTable had a legacy tool to view, manage, and add tags manually.
